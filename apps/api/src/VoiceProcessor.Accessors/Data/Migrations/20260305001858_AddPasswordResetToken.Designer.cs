...
namespace VoiceProcessor.Accessors.Data.Migrations
{
    ...
    [Migration("20260305001858_AddPasswordResetToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoiceProcessor.Domain.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoiceProcessor.Domain.Entities.CreditDeduction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("credit_deductions", (string)null);
                });
            ...
            modelBuilder.Entity("VoiceProcessor.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoiceProcessor.Domain.Entities.PaymentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoiceProcessor.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoiceProcessor.Domain.Entities.PasswordResetToken", b =>
                {
                    b.HasOne("VoiceProcessor.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
