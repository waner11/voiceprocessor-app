  ...
  return (
    <div className="rounded-lg border border-border-subtle bg-bg-elevated p-6 space-y-4 transition-shadow hover:shadow-soft-2">
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full rounded-lg bg-indigo px-4 py-2 text-text-inverse hover:bg-indigo-dark active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed transition"
      >
