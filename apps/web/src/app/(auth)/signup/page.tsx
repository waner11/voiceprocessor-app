    ...
    <div className="space-y-6">
       <div className="text-center">
         ...
         <p className="mt-2 text-text-secondary">
           Get 10,000 free characters to start
         </p>
       </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
         ...
         <div>
           ...
           />
           {errors.name && (
             <p className="mt-1 text-sm text-state-error-text">{errors.name.message}</p>
           )}
         </div>
       ...
       <div className="grid grid-cols-2 gap-3">
         <button
           type="button"
           className="flex items-center justify-center gap-2 rounded-lg border border-border-subtle py-2.5 text-text-secondary hover:bg-bg-sunken"
         >
       ...
       <p className="text-center text-xs text-text-muted">
         ...
         <Link href="/terms" className="hover:underline hover:text-text-secondary">
           Terms of Service
         </Link>{" "}
         and{" "}
         <Link href="/privacy" className="hover:underline hover:text-text-secondary">
           Privacy Policy
         </Link>
       </p>
    </div>
